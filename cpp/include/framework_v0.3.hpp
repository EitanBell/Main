...
/*
THIS VERSION (V0.3) INCLUDES REACTOR, THREADPOOL, LOGGER, FACTORY, PLUGINS 
                                   ...
                                   m_thread(InitThread(messages))
{
    ...
    Handleton<Logger>::GetInstance()->Log("Framework v0.3 is ON.");
}
...
Framework<BASE, KEY, DATA>::~Framework()
{
    ...
    Handleton<Logger>::GetInstance()->Log("Framework v0.3 is OFF.");
}
