...
typedef struct PublicTranspotVtable
{
	void (*Dtor)(void *this);
...
void PublicTransportPrint_count(void);
...
void MinibusDisplay(void *this)
{
    printf("Minibus::display() ID:%d ",PublicTransportGetID((pub_trans_t *)this));
...
typedef struct PublicConvoy_vtable
{
    void (*Dtor)(void *this);
    void (*Display)(void *this);
} publicconvoy_vtable_t;
