...
{			
	return ~BitArrUnsetAll(bitarr); 	/*Better without calling the func: ~(bitarr & 0)*/
}
...
{
	return (bitarr >> (i) & (size_t)bit_on);	/*option 2: bitarr & ((bit_array_t)(bit_on) << i)*/
}
